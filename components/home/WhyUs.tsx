      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center flex-col justify-center min-h-[700px]">
          ...
          <div className="relative">
            {/* Animated Circle */}
            <div className="w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] rounded-full bg-black relative overflow-hidden animate-bounce-slow shadow-2xl border-4 border-red-500">

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-1 text-black">{t('contact.address.title')}</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-1 text-black">{t('contact.phone.title')}</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-1 text-black">{t('contact.email.title')}</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-1 text-black">{t('contact.hours.title')}</h3>
            ...
            {/* Contact Form */}
            <div className="bg-[#424242] rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-8 text-white">{t('form.title')}</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="bg-[#424242] border-gray-600 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium mb-2 text-white">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#424242] border border-gray-600 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500 rounded-md px-3 py-2"
                    >
